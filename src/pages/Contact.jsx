...
function Contact() {
  ...
  return (
    <section ref={el=>addRef(el)} id="contact" className=" flex justify-center mt-10  py-40 px-20 overflow-hidden">
      <motion.div
        ...
        whileInView="animate"
      >
        <motion.div className=" flex-col text-gray-800 dark:text-gray-200 gap-4 flex  capitalize ">
          <motion.h1
            className=" text-pink-500 text-7xl font-semibold mb-5 "
            variants={variants}
          >
            contact me now !
          </motion.h1>
        ...
        <div className=" relative" ref={ref}>
          ...
          >
            ...
            whileInView={{ opacity: 0 }}
            transition={{ delay: 3, duration: 1 }}
              className=" z-[1] absolute m-auto stroke-pink-600 w-[20rem] h-[20rem] lg:w-[450px] lg:h-[450px]"
		...
		C501.071,340.717,512,299.589,512,256C511.98,114.604,397.389,0.012,255.998,0.002z"
          ...
          >
            <input
              className=" p-4 px-8 text-gray-800 bg-gray-100 rounded-lg border-pink-400 border-2 outline-none"
              type="text"
              required
              placeholder="name"
              name="name"
            ...
            <textarea
              ...
              name="message"
            ></textarea>
            <button className=" bg-pink-600 text-gray-100 px-3 py-4 border-none">
              Submit
            </button>
            <span className=" text-pink-600 ">{err&&"Error"}
